...
<nav class="flex items-center justify-between flex-wrap bg-black py-3 lg:px-12 shadow border-solid border-t-2 border-blue-700">
    <div class="flex justify-between lg:w-auto w-full lg:border-b-0 pl-6 pr-2 border-solid border-b-2 border-gray-300 pb-5 lg:pb-0">
        <div class="flex items-center flex-shrink-0 text-gray-800 mr-16">
            ...
            <a href="/">
                <img class="text-1xl font-bold uppercase text-purple-100" src="{{ asset('storage/images/crowdfunding.jpg') }}" width="120" height="10" />
            </a>
        </div>
    ...
    <div id="mySidepanel" class="sidepanel">
        ...
        @if (Route::has('login'))
            @auth
                <a href="{{ url('/dashboard') }}" class="bg-purple-200 hover:bg-purple-300 rounded-full uppercase text-purple-700 py-3 px-3">Dashboard</a>
            @else
                <a href="{{ route('login') }}" class="border-double border-4 border-light-blue-500 bg-purple-200 hover:bg-purple-300 rounded-full uppercase text-purple-700 py-3 px-3">Login</a>

                @if (Route::has('register'))
                    <a href="{{ route('register') }}" class="border-double border-4 border-light-blue-500 bg-purple-200 hover:bg-purple-300 rounded-full uppercase text-purple-700 py-3 px-3">Sign Up</a>
                @endif
            @endauth
        @endif
    </div>
