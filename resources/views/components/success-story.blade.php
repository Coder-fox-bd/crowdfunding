...
<main class="relative flex items-center justify-center" x-data="carouselFilter()">
    <div class="inset-0 container grid grid-cols-1">      
        <div class="row-start-2 col-start-1"
          ...
          <div class="relative grid grid-cols-1 text-white text-center justify-items-center py-10 md:py-20 md:mb-12 z-10">
              <h1 class="text-4xl md:text-5xl">Success Stories</h1>
          </div>
          <div class="grid grid-cols-1 grid-rows-1" x-data="carousel()" x-init="init()">  
            <div class="carousel col-start-1 row-start-1 z-20" x-ref="carousel">
                <div class="bg-white p-2 mx-4 w-80 max-w-3xl sm:w-full sm:p-4 h-auto sm:h-64 rounded-2xl shadow-lg flex flex-col sm:flex-row gap-5 select-none">
                    <div
          ...
          <div class="relative grid grid-cols-1 md:grid-cols-2 gap-4 text-white text-center justify-items-center py-8 z-10">
            <button class="py-2 px-5 md:ml-auto bg-blue-500 hover:bg-blue-600 text-gray-100 text-lg rounded-lg focus:border-4 border-blue-300">STAR A FUNDRISER FOR FREE</button>
            <button class="py-2 px-24 md:mr-auto uppercase bg-transparent border-2 border-blue-500 text-blue-500 text-lg rounded-lg hover:bg-blue-500 hover:text-gray-100 focus:border-4 focus:border-blue-300">Talk to Us</button>
          </div>
        </div>      
    </div>
